 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://myHelloWorld/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://myHelloWorld/", "HelloWorldImplService");
